...
| `pin_advice_type` | `Integer` | Required | PIN delivery method.<br>Mandatory<br>Allowed Values:<br><br>1. Paper<br><br>2. Email<br><br>3. SMS<br><br>4. None<br>   Note: - Paper delivery not applicable for selfselctedPIN type and FleetPIN enabled Accounts<br><br>**Constraints**: `>= 1`, `<= 3` |
