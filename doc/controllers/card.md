...
body = CardManagementV1OrdercardRequest.new(
  [
    CardDetail.new(
      1,
      1,
...
body = CardManagementV1CancelRequest.new(
  [
    UpdateCard.new(
      'NextGenUI',
      true,
...
body = CardManagementV1UpdatestatusRequest.new(
  [
    UpdateCard.new(
      'Motix',
      true,
...
```ruby
def purchase_category(request_id,
                      body: nil)
```
...
result = card_controller.purchase_category(request_id)
puts result
```
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `request_id` | `String` | Header, Required | UUID (according to RFC 4122 standards) for requests and responses. This will be played back in the response from the request. |
...
body = CardDetailsReq.new(
  CardDetailsRequest.new(
    32,
    nil,
    nil,
    nil,
...
body = CardManagementV1PinreminderRequest.new(
  nil,
  'CZ00000927',
  32,
  nil,
