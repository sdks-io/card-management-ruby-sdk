...
module ShellCardManagementApIs
  # UpdateBundleRes Model.
  class UpdateBundleRes < BaseModel
    SKIP = Object.new
    ...
    # Status of the request
    # @return [Array[UpdateBundleResponse]]
    attr_accessor :data
    ...
    def self.from_hash(hash)
      ...
      unless hash['Data'].nil?
        ...
        hash['Data'].each do |structure|
          data << (UpdateBundleResponse.from_hash(structure) if structure)
        end
      end
      ...
      UpdateBundleRes.new(request_id,
                          status,
                          data)
    end
