...
module ShellCardManagementApIs
  # CreateBundleRes Model.
  class CreateBundleRes < BaseModel
    SKIP = Object.new
    ...
    # Status of the request
    # @return [Array[CreateBundleResponse]]
    attr_accessor :data
    ...
    def self.from_hash(hash)
      ...
      unless hash['Data'].nil?
        ...
        hash['Data'].each do |structure|
          data << (CreateBundleResponse.from_hash(structure) if structure)
        end
      end
      ...
      CreateBundleRes.new(request_id,
                          status,
                          data)
    end
