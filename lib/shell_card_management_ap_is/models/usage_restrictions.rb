...
module ShellCardManagementApIs
  ...
  class UsageRestrictions < BaseModel
    ...
    # Optional
    # The value ‘0’ represents not set. If Values is passed as null, will be
    ...
    def initialize(daily_spend = SKIP,
                   weekly_spend = SKIP,
                   monthly_spend = SKIP,
                   ...
                   annual_spend = SKIP,
                   life_time_spend = SKIP,
                   annual_volume = SKIP,
                   life_time_volume = SKIP,
    ...
    def self.from_hash(hash)
      ...
      UsageRestrictions.new(daily_spend,
                            weekly_spend,
                            monthly_spend,
                            per_transaction_spend,
                            daily_volume,
