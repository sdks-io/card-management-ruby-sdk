...
module ShellCardManagementApIs
  # UpdateCardGroupRes Model.
  class UpdateCardGroupRes < BaseModel
    SKIP = Object.new
    ...
    # Status of the request
    # @return [Array[UpdateCardGroupResponse]]
    attr_accessor :data
    ...
    def self.from_hash(hash)
      ...
      unless hash['Data'].nil?
        ...
        hash['Data'].each do |structure|
          data << (UpdateCardGroupResponse.from_hash(structure) if structure)
        end
      end
      ...
      UpdateCardGroupRes.new(request_id,
                             status,
                             data)
    end
