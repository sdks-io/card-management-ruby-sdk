...
module ShellCardManagementApIs
  # SummaryOfBundleResponseDataItemsCardBundlesItems Model.
  class SummaryOfBundleResponseDataItemsCardBundlesItems < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      SummaryOfBundleResponseDataItemsCardBundlesItems.new(bundle_id,
                                                           external_bundle_id,
                                                           description,
                                                           total_cards)
    end
