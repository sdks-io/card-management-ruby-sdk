...
module ShellCardManagementApIs
  ...
  class CardMoveResponse < BaseModel
    ...
    def to_s
      ...
      "<#{class_name} move_card_request_reference: #{@move_card_request_reference},"\
      " successful_requests: #{@successful_requests}, error_cards: #{@error_cards}, request_id:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} move_card_request_reference: #{@move_card_request_reference.inspect},"\
      " successful_requests: #{@successful_requests.inspect}, error_cards:"\
      " #{@error_cards.inspect}, request_id: #{@request_id.inspect}, error: #{@error.inspect}>"
    end
  end
end
