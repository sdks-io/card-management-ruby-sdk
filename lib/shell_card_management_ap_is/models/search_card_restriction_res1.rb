...
module ShellCardManagementApIs
  # SearchCardRestrictionRes1 Model.
  class SearchCardRestrictionRes1 < BaseModel
    SKIP = Object.new
    ...
    # Status of the request
    # @return [Array[SearchCardRestrictionRes]]
    attr_accessor :data
    ...
    def self.from_hash(hash)
      ...
      unless hash['Data'].nil?
        ...
        hash['Data'].each do |structure|
          data << (SearchCardRestrictionRes.from_hash(structure) if structure)
        end
      end
      ...
      SearchCardRestrictionRes1.new(request_id,
                                    status,
                                    data)
    end
