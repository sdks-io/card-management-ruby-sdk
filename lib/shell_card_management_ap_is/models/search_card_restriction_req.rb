...
module ShellCardManagementApIs
  ...
  class SearchCardRestrictionReq < BaseModel
    ...
    def to_s
      ...
      " #{@payer_id}, payer_number: #{@payer_number}, accounts: #{@accounts}, bundle_id:"\
      " #{@bundle_id}, cards: #{@cards}, include_location_restrictions:"\
      " #{@include_location_restrictions}, include_bundle_details: #{@include_bundle_details},"\
      " include_inherited_limits: #{@include_inherited_limits}>"
    end
    ...
    def inspect
      ...
      " #{@accounts.inspect}, bundle_id: #{@bundle_id.inspect}, cards: #{@cards.inspect},"\
      " include_location_restrictions: #{@include_location_restrictions.inspect},"\
      " include_bundle_details: #{@include_bundle_details.inspect}, include_inherited_limits:"\
      " #{@include_inherited_limits.inspect}>"
    end
  end
end
