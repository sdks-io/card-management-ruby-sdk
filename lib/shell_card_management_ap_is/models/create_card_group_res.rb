...
module ShellCardManagementApIs
  # CreateCardGroupRes Model.
  class CreateCardGroupRes < BaseModel
    SKIP = Object.new
    ...
    # Status of the request
    # @return [Array[CreateCardGroupResponse]]
    attr_accessor :data
    ...
    def self.from_hash(hash)
      ...
      unless hash['Data'].nil?
        ...
        hash['Data'].each do |structure|
          data << (CreateCardGroupResponse.from_hash(structure) if structure)
        end
      end
      ...
      CreateCardGroupRes.new(request_id,
                             status,
                             data)
    end
