...
module ShellCardManagementApIs
  ...
  class PINReminderReference < BaseModel
    ...
    def initialize(card_id = SKIP, panid = SKIP, pan = SKIP,
                   card_expiry_date = SKIP, reference_id = SKIP)
    ...
    def to_s
      ...
      " #{@card_expiry_date}, reference_id: #{@reference_id}>"
    end
    ...
    def inspect
      ...
      " #{@pan.inspect}, card_expiry_date: #{@card_expiry_date.inspect}, reference_id:"\
