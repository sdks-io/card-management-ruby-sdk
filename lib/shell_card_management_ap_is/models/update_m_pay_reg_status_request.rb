...
module ShellCardManagementApIs
  ...
  class UpdateMPayRegStatusRequest < BaseModel
    ...
    def to_s
      ...
      " #{@payer_id}, payer_number: #{@payer_number}, m_pay_requests: #{@m_pay_requests}>"
    end
    ...
    def inspect
      ...
      " payer_id: #{@payer_id.inspect}, payer_number: #{@payer_number.inspect}, m_pay_requests:"\
      " #{@m_pay_requests.inspect}>"
    end
  end
end
