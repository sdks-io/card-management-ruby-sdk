...
module ShellCardManagementApIs
  ...
  class ProductRestrictionCard < BaseModel
    SKIP = Object.new
    ...
    def to_s
      ...
      "<#{class_name} products: #{@products}, product_groups: #{@product_groups}>"
    end

    # Provides a debugging-friendly string with detailed object information.
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} products: #{@products.inspect}, product_groups:"\
      " #{@product_groups.inspect}>"
    end
  end
end
