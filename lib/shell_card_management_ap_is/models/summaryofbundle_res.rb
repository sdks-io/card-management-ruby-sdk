...
module ShellCardManagementApIs
  # SummaryofbundleRes Model.
  class SummaryofbundleRes < BaseModel
    SKIP = Object.new
    ...
    # Status of the request
    # @return [Array[SummaryofbundleResponse]]
    attr_accessor :data
    ...
    def self.from_hash(hash)
      ...
      unless hash['Data'].nil?
        ...
        hash['Data'].each do |structure|
          data << (SummaryofbundleResponse.from_hash(structure) if structure)
        end
      end
      ...
      SummaryofbundleRes.new(request_id,
                             status,
                             data)
    end
