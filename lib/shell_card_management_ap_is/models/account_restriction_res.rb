...
module ShellCardManagementApIs
  # AccountRestrictionRes Model.
  class AccountRestrictionRes < BaseModel
    SKIP = Object.new
    ...
    # Status of the request
    # @return [Array[AccountRestrictionResponse]]
    attr_accessor :data
    ...
    def self.from_hash(hash)
      ...
      unless hash['Data'].nil?
        ...
        hash['Data'].each do |structure|
          data << (AccountRestrictionResponse.from_hash(structure) if structure)
        end
      end
      ...
      AccountRestrictionRes.new(request_id,
                                status,
                                data)
    end
