...
module ShellCardManagementApIs
  # SearchAccountLimitRes Model.
  class SearchAccountLimitRes < BaseModel
    SKIP = Object.new
    ...
    # Status of the request
    # @return [Array[SearchAccountLimitResponse]]
    attr_accessor :data
    ...
    def self.from_hash(hash)
      ...
      unless hash['Data'].nil?
        ...
        hash['Data'].each do |structure|
          data << (SearchAccountLimitResponse.from_hash(structure) if structure)
        end
      end
      ...
      SearchAccountLimitRes.new(request_id,
                                status,
                                data)
    end
