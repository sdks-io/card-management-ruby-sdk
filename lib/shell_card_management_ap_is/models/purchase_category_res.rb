...
module ShellCardManagementApIs
  # PurchaseCategoryRes Model.
  class PurchaseCategoryRes < BaseModel
    SKIP = Object.new
    ...
    # Status of the request
    # @return [Array[PurchaseCategoryResponse]]
    attr_accessor :data
    ...
    def self.from_hash(hash)
      ...
      unless hash['Data'].nil?
        ...
        hash['Data'].each do |structure|
          data << (PurchaseCategoryResponse.from_hash(structure) if structure)
        end
      end
      ...
      PurchaseCategoryRes.new(request_id,
                              status,
                              data)
    end
