...
module ShellCardManagementApIs
  ...
  class CardManagementV1UpdatestatusRequest < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      CardManagementV1UpdatestatusRequest.new(cards,
                                              target_status,
                                              reason_id,
                                              reason_text)
    end
    ...
    def to_s
      ...
      "<#{class_name} cards: #{@cards}, reason_id: #{@reason_id}, reason_text: #{@reason_text},"\
      " target_status: #{@target_status}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} cards: #{@cards.inspect}, reason_id: #{@reason_id.inspect}, reason_text:"\
      " #{@reason_text.inspect}, target_status: #{@target_status.inspect}>"
    end
  end
end
