...
module ShellCardManagementApIs
  ...
  class CardController < BaseController
    ...
    # to RFC 4122 standards) for requests and responses. This will be played
    # back in the response from the request.
    # @param [PurchaseCategoryReq] body Optional parameter: PurchaseCategory
    # request body
    ...
    def purchase_category(request_id,
      ...
      @api_call
        .request(new_request_builder(HttpMethodEnum::POST,
                                     '/config-data/v1/purchasecategory',
                                     Server::SHELL)
                   .header_param(new_parameter(request_id, key: 'RequestId'))
                   .header_param(new_parameter('application/json', key: 'Content-Type'))
                   .body_param(new_parameter(body))
        ...
        .response(new_response_handler
                    .deserializer(APIHelper.method(:custom_type_deserializer))
                    .deserialize_into(PurchaseCategoryRes.method(:from_hash))
                    .local_error('400',
                                 "The server cannot or will not process the request due to'\
                                  ' something that is perceived to be a client error (e.g.,'\
                                  ' malformed request syntax, invalid request message framing, or'\
    ...
    # @param [String] request_id Required parameter: UUID (according to RFC 4122
    # standards) for requests and responses. This will be played back in the
    # response from the request.
    # @param [CardDetailsReq] body Required parameter: Card Details request
    # body
    ...
    # standards) for requests and responses. This will be played back in the
    # response from the request.
    # @param [CardMoveRequest] body Required parameter: schedulecardblock
    # request body
    ...
    def card_move(request_id,
      ...
      @api_call
        ...
        .response(new_response_handler
                    .deserializer(APIHelper.method(:custom_type_deserializer))
                    .deserialize_into(CardMoveRes.method(:from_hash))
                    .local_error('400',
                                 "The server cannot or will not process the request due to'\
                                  ' something that is perceived to be a client error (e.g.,'\
                                  ' malformed request syntax, invalid request message framing, or'\
    ...
    # standards) for requests and responses. This will be played back in the
    # response from the request.
    # @param [DeliveryAddressUpdateRequest] body Required parameter: Delivery
    ...
    def deliveryaddressupdate_v2(request_id,
      ...
      @api_call
        ...
        .response(new_response_handler
                    .deserializer(APIHelper.method(:custom_type_deserializer))
                    .deserialize_into(ResponseDeliveryAddressUpdate.method(:from_hash))
                    .local_error('400',
                                 "The server cannot or will not process the request due to'\
                                  ' something that is perceived to be a client error (e.g.,'\
                                  ' malformed request syntax, invalid request message framing, or'\
