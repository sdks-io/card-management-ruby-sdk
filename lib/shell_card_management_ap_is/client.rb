...
module ShellCardManagementApIs
  ...
  class Client
    ...
    # @return [RestrictionController] Returns the controller instance.
    def restriction
      @restriction ||= RestrictionController.new @global_configuration
    end

    # Access to card controller.
    # @return [CardController] Returns the controller instance.
    def card
      @card ||= CardController.new @global_configuration
    end
